    ...
    <body>
       ...
       <!-------Nav bar closed-----> 
        ...
        <div id="id1" class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4"><u>SHORTLISTED CANDIDATES</u></h1>
            </div>
        </div>
        
        <div class="container">
            <h3><b>COMPANY A : CRITERIA : 70%</b></h3>
            <table class="table">
              ...
              <tbody>
                <?php
                  ...
                  $query = "select name, rollno from studentdetails where percentage>=70";
                  $rs = $con->query($query);
                  $i=1;
            ...
            <h3><b>COMPANY B : CRITERIA : 60%</b></h3>
            <table class="table">
              <thead class="thead-dark">
                <tr>
                  <th scope="col">#</th>
              ...
              <tbody>
                <?php
                  ...
                  $query = "select name, rollno from studentdetails where percentage>=60 && percentage<70";
                  $rs = $con->query($query);
                  $i=1;
                  while($row=$rs->fetch_assoc()){
                    echo "<tr>
